...
def find_maximal_independent_set(filename, sub_filename):
    ...
    for idx, pat_graph in enumerate(graphs):
        ...
        # PROBLEM: Unable to deal with cycles --> Currently capped it at 100 to avoid the problem
        # TODO: Fix this in the future
        instances_gen = itertools.islice(test.subgraph_isomorphisms_iter(), 300) # TEMP FIX
        # print(instances_gen.)
        ...
        newNodes = []
        newEdges = []
        # PROBLEM: Unable to handle cycles as there is no checking mechanism if the node has been visited
