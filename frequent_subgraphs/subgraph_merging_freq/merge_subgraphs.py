...
from subgraph_merging_freq.gen_eblif import gen_eblif
...
def merge_subgraphs(file_ind_pairs, pipeline):
    ...
    print("Converting Merged Graph to Eblif")
    gen_eblif()
